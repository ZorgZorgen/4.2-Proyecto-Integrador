...
export class ProductInsertComponent implements CanDeactivate<any>, OnInit {
    ...
    this.productService
      ...
      .subscribe(
        product => {
          ...
          this.notificationService.notifyMessage('Producto nuevo guardado.');
          this.router.navigateByUrl("/products");
        },
        error => this.notificationService.notifyError('No se pudo guardar tu producto. ' + error)
      );
  }
  ...
  canDeactivate(): Observable<boolean> | boolean {
    ...
    // promesa que resuelve a f/v cuando decida el usuario
