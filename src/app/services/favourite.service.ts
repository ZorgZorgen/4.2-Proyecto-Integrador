...
export class FavouriteService {
    ...
    addToFavourites(product: Product): void {
        ...
        this.notificationService.notifyMessage(`Producto ${product.name} agregado a tus favoritos.`);
    }

    removeFromFavourites(product:Product): void {
        this._favourites.delete(product);
        this.notificationService.notifyMessage(`Producto ${product.name} eliminado de tus favoritos.`);
    }  
